...
Future<void> createAlbum(String newFirstName,String newLastName, String newPassword) async {
  Response response;
 ...
 try {
  ...
  response = await dio.patch("$URL/api/v0/pharmacists/profile", data: {"newFirstName":newFirstName , "newLastName": newLastName,"NewPassword": newPassword});
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
        ...
        margin: Responsive.isDesktop(context)? const EdgeInsets.only(
                 ...
                 top: 10, left: 55, right: 0, bottom: 15) ,
       ...
       children: [
         ...
         Image.asset('images/Asset3.png', height: height*0.4, width: width*0.35
                 ): const SizedBox(),
                           ...
                           SizedBox(height: height*0.02, ),
                            Center(
                             child: RichText(text:  TextSpan(
                               children:[
                                 TextSpan(
                                   text: 'Fill the form to update your personal infos',
                                   style: TextStyle(fontWeight: FontWeight.w600,
                                   decorationColor: Colors.red,
                                   color: Colors.red,
                                   fontSize: Responsive.isDesktop(context)? 13.0 : 9.0,
                                   fontFamily: 'assets/fonts/Raleway-SemiBold.ttf')
                                 )
                               ])),
                           ),
                                          ...
                                          SizedBox(height: height*0.02,),
                                           ...
                                           SizedBox(
                                                   ...
                                                   backgroundColor: MaterialStateProperty.all(kPrimaryColor),
                                                       ...
                                                       onPressed: () {
                                                          setState(() async{
                                                           await createAlbum(newFirstNameController.text.toString(),  newLastNameController.text.toString(), newPasswordController.text.toString());
