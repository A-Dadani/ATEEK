...
Future<void> createAlbum(String name, String qty, String description,
    String priceDH, List fileInfo) async {
...
class Album {
  ...
  Album(
      {this.name, this.description, this.qty, this.priceDH, this.pictureLink});
    ...
    return Expanded(
      ...
      child: Container(
        margin: Responsive.isDesktop(context)
            ...
            : const EdgeInsets.only(top: 10, left: 60, right: 0, bottom: 15),
        ...
        child: Row(
          children: [
            Responsive.isDesktop(context)
                ? Image.asset('images/Asset 6.png',
                    height: height * 0.4, width: width * 0.35)
                : const SizedBox(),
            SingleChildScrollView(
              child: SizedBox(
                height:
                    Responsive.isDesktop(context) ? height * 1.4 : height * 1.4,
                width:
                    ...
                    children: [
                        ...
                        child: RichText(
                          ...
                          TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontSize:
                                      Responsive.isDesktop(context) ? 30.0 : 25,
                                  fontFamily:
                      ...
                      Center(
                        child: RichText(
                          ...
                          TextSpan(
                              text:
                                  'Fill the form to add medecines to your stock',
                              style: TextStyle(
                                  fontWeight: FontWeight.w600,
                                  decorationColor: Colors.red,
                                  color: Colors.red,
                                  fontSize:
                                      Responsive.isDesktop(context) ? 13.0 : 10,
                                  fontFamily:
                                      'assets/fonts/Raleway-SemiBold.ttf'))
                        ])),
                      ),
