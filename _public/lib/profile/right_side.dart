...
Future<void> patchState(bool isGarde) async {
  ...
  try {
    ...
    response =
        await dio.patch("$URL/api/v0/pharmacies/", data: {"isGarde": isGarde});
...
class RrightSideState extends State<RightSide> {
  ...
  Future<void> _getMedicines() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'http://localhost:5000/api/v0/pharmacies/$pharmacyID/allProducts'));
    ...
    return Expanded(
      ...
      child: Container(
        margin: Responsive.isDesktop(context)
            ? EdgeInsets.only(top: 20, right: 10, bottom: 20)
            : EdgeInsets.only(top: 5, left: 90, right: 10, bottom: 5),
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    color: Colors.red,
                                    fontSize:
                                        Responsive.isDesktop(context) ? 24 : 15,
  ...
  Container appBar({dynamic backgroundColor = kLabelColor}) {
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
