                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        height: Responsive.isDesktop(context)? height*0.95:
                          height*1.75,
                            ...
                            children: [ 
                              Expanded(
                                ...
                                child: Container(child: Column(
                                  children: [
                                    Text('$i/3', style: TextStyle(fontSize: Responsive.isDesktop(context)?16.0 : 12),),
                                    
                                     Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        SizedBox(width: Responsive.isDesktop(context)? 100: 60, height: Responsive.isDesktop(context)? 15: 10,
                                          child:  DecoratedBox(
                                  ...
                                  i==1? SingleChildScrollView(
                                    ...
                                    child: RichText(text: TextSpan(
                                      children:[
                                        TextSpan(
                                          ...
                                          fontSize: Responsive.isDesktop(context)? 25.0: 20,
                                      ...
                                      RichText(text: TextSpan(
                                          children:[
                                            TextSpan(
                                              ...
                                              style: TextStyle(fontWeight: FontWeight.w600,
                                              fontSize: Responsive.isDesktop(context)? 15.0: 13,
                                              color: kPrimaryColor,
                                              fontFamily: 'assets/fonts/Raleway-SemiBold.ttf')
                                            )
                                          ])),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: SizedBox(
                                          width: Responsive.isMobile(context)? width*0.6 : 
                                          width*0.15,
                                          height: 90,
                                           child: Padding(
